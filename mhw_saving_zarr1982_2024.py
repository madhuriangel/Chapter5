...
- This is compute-heavy (loop over all grid cells). For large grids, consider
  parallelisation (dask / joblib) or chunked approaches.
...
# ordinal time required by your detect()
